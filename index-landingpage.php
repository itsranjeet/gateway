                ...
                <nav>
                  <ul class="nav topnav">
                    <li class="dropdown active">
                      <a href="index.php"><i class="icon-home"></i> Home <i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="index-alt2.php">Homepage 2</a></li>
                        <li><a href="index-alt3.php">Homepage 3</a></li>
                        <li><a href="index-alt4.php">Parallax slider</a></li>
                        <li><a href="index-landingpage.php">Landing page</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"><a href="#">3rd menus<i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            <li><a href="index.php">Sub menu</a></li>
                            <li><a href="index.php">Sub menu</a></li>
                          </ul>
                        </li>
                      </ul>
      ...
      <div class="landing">
        <div class="container">
          <div class="row">
            ...
            <div class="span6">
              <h2><strong>Put your <span class="colored">Opt in form</span></strong></h2>
