            ...
            <div class="row">
              <section id="projects">
                <ul id="thumbs" class="grid cs-style-4 portfolio">
                  ...
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span4 graphic" data-id="id-2" data-type="graphic">
                    <div class="item">
                      <figure>
                  ...
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span4 web" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                  ...
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span4 web" data-id="id-4" data-type="web">
                    <div class="item">
                      <figure>
                  ...
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span4 icon" data-id="id-5" data-type="icon">
                    <div class="item">
                      <figure>
                  ...
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span4 graphic" data-id="id-0" data-type="graphic">
                    <div class="item">
                      <figure>
